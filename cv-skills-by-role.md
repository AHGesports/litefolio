# CV Skills by Target Role (v5 - Standardized)

> **How to use**: Copy the flat list for your target role.
> All CVs include: Frontend, Databases, Auth, APIs, Testing, DevOps, Methodology.
> Testing tools vary by ecosystem.

---

## 0. General CV (Senior Software Engineer / Full-Stack Developer)

### When to Use:
Jobs that don't fit 100% into one ecosystem, or when they want a generalist/full-stack engineer.
...
## 1. .NET Ecosystem (Senior .NET Developer / Backend Engineer)

### What .NET Hiring Managers Search For:
C#, ASP.NET Core, Entity Framework, Azure, SQL Server, Microservices, Docker
...
| **Testing** | TDD, xUnit, Moq, FluentAssertions |
| **DevOps** | Docker, Azure, Vercel, Linux, GitHub Actions, Azure DevOps, Git, CI/CD |
| **Desktop** | WPF |
| **Methodology** | Agile, Scrum |
...
## 2. JavaScript/TypeScript Ecosystem (Frontend / Angular Developer)

### What Frontend Hiring Managers Search For:
TypeScript, Angular, React, RxJS, Tailwind, Jest, Node.js

### Grouped View
| Category | Skills |
|----------|--------|
| **Languages** | TypeScript, JavaScript (ES2025), SQL, C#, Python |
| **Frontend Frameworks** | Angular, Astro |
...
| **Auth & Security** | JWT, OAuth 2.0, SSO, RBAC |
| **Architecture** | SOLID Principles, System Design, Microservices |
| **Testing** | Jest, TDD, Playwright, Puppeteer |
| **DevOps** | Docker, Azure, Vercel, Linux, GitHub Actions, Git, CI/CD |
| **Methodology** | Agile, Scrum |
...
## 3. Python Ecosystem (Python Developer / Backend Engineer)

### What Python Hiring Managers Search For:
Python, FastAPI, Django, PostgreSQL, Redis, Docker, pytest
...
| **Automation** | Web Scraping, BeautifulSoup |
| **AI Integration** | OpenAI API, Anthropic API, Google Gemini API, LangChain |
| **DevOps** | Docker, Azure, Vercel, Linux, GitHub Actions, Git, CI/CD |
| **Async** | asyncio |
| **Methodology** | Agile, Scrum |
...
## 4. Node.js Ecosystem (Node.js Developer / Backend Engineer)

### What Node.js Hiring Managers Search For:
Node.js, TypeScript, Express, PostgreSQL, Redis, Docker, Jest
...
## 5. AI & Workflow Automation (AI Engineer / Automation Specialist)

### What AI Hiring Managers Search For:
Python, OpenAI, LangChain, Prompt Engineering, RAG, AI Agents, Automation
...
| **Testing** | pytest, TDD, Playwright, Puppeteer, Selenium |
| **DevOps** | Docker, Azure, Vercel, Linux, GitHub Actions, Git, CI/CD |
| **Methodology** | Agile, Scrum |
...
## Standardized Sections (Present in ALL CVs)
...
| CV | Testing Tools |
|----|---------------|
| **General** | TDD, xUnit, Jest, pytest |
| **.NET** | TDD, xUnit, Moq, FluentAssertions |
| **JS/TS** | Jest, TDD, Playwright, Puppeteer |
| **Python** | pytest, TDD, Playwright, Selenium |
| **Node.js** | Jest, TDD, Playwright, Puppeteer |
| **AI** | pytest, TDD, Playwright, Puppeteer, Selenium |

---

## Quick Reference: All CVs at a Glance

| CV | Primary Focus | Ecosystem-Specific |
|----|---------------|-------------------|
| **General** | Balanced full-stack | All core skills |
| **.NET** | C#, ASP.NET, EF, Azure | EF Core, NHibernate, Dapper, WPF, Blazor, Azure DevOps |
| **JS/TS** | TypeScript, Angular, Node | Angular Signals, Astro, PrimeNG, SCSS/SASS |
| **Python** | Python, FastAPI, AI | Pydantic, httpx, aiohttp, asyncio, AI APIs, BeautifulSoup |
| **Node.js** | Node, Express, TS | BullMQ, Event-Driven Architecture, WebSockets |
| **AI** | LLM APIs, Agents, Automation | Browser-use, Computer-use, n8n, Crawlee, Apify |

---

## Removed from All CVs

| Removed | Why |
|---------|-----|
| Domain expertise | Belongs in experience section, not skills |
| API Versioning | Too specific, Swagger/OpenAPI covers it |
| Code Review | Activity everyone does |
| Performance Optimization | Vague, show in experience |

---

## Character Counts (Updated)

| Version | Character Count | Status |
|---------|-----------------|--------|
| General | ~430 chars | OK |
| .NET | ~590 chars | OK |
| JS/TS | ~480 chars | OK |
| Python | ~510 chars | OK |
| Node.js | ~490 chars | OK |
| AI/Automation | ~560 chars | OK |

All fit within LinkedIn's 2000-char limit with room for customization.
